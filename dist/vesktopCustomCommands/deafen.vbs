' VesktopCustomCommands - Silent Deafen Trigger
Option Explicit

Dim fso, shell, userProfile, appData, configFile, defaultVencord, vencordPath
Dim file, line, parts, key, val, targetDir, deafenFile, procs
...
deafenFile = targetDir & "\deafen"

If Not fso.FolderExists(targetDir) Then
    fso.CreateFolder(targetDir)
End If

fso.CreateTextFile(deafenFile, True).Close
